...
export async function POST(request: Request) {
  ...
  const { text: title } = await generateText({
    ...
    system:
      "Summarize this acquisition intelligence conversation in 6-10 words as a short title. No quotes, no punctuation at the end. Be specific — mention the vertical and geography if discussed.",
    prompt: lines.join("\n"),
  });
